...
CATEGORY_COLORS = {
    "scan":      {"bg": "#065f46", "fg": "#a7f3d0", "border": "#34d399"},
    "join":      {"bg": "#1e3a5f", "fg": "#93c5fd", "border": "#60a5fa"},
    "sort":      {"bg": "#78350f", "fg": "#fde68a", "border": "#fbbf24"},
    "aggregate": {"bg": "#4c1d95", "fg": "#c4b5fd", "border": "#a78bfa"},
    "limit":     {"bg": "#831843", "fg": "#fbcfe8", "border": "#f472b6"},
    "other":     {"bg": "#374151", "fg": "#d1d5db", "border": "#9ca3af"},
}
